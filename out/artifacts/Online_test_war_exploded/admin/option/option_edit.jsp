...
function modify() {
	  var option_content=document.getElementById("option_content").value;
		 ...
		 <input type="hidden" name="id" value="${option_info.id}"/>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline layui-input">
                        ...
                        <input type="hidden" name="question_num_id" value="${option_info.questionNumId}">
                    </div> 
                </div>
                <div class="layui-form-item">
                    ...
                    ${option_info.optionType}
                        <input type="hidden" name="option_type" value="${option_info.optionType}">
                    </div>
                </div>
                <div class="layui-form-item">
